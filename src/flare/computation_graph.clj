...
(defrecord MultinomialSampleGraphOp []
  GraphOp
  (op-key [this] :multinomial-sample)
  (op-validate! [this nodes]
    (-ensure-arity 1 nodes))
  (op-descriptor [this] "multinomial-sample")
  (forward-shape [this nodes] [1]))
...
(defn multinomial-sample
  [x]
  (add-graph-op (MultinomialSampleGraphOp.) [x]))
